...
public void OnPluginStart() {
	g_classID = CodD0_RegisterClass("Rakietnik", "Posiada 3 rakiety", {0, 10, 15, 20}, { CSWeapon_AK47, CSWeapon_GLOCK, CSWeapon_FLASHBANG }, 3);
...
public Action CodD0_ClassChanged(int client, int classID) {
	if(g_classID != classID && g_hasClass[client]) {
		CodD0_SetClientRockets(client, CodD0_SkillSlot_Class, 0, 0.0, 0.0);
...
public void CodD0_ClassChanged_Post(int client, int classID) {
	if(g_classID == classID) {
		CodD0_SetClientRockets(client, CodD0_SkillSlot_Class, 3, 80.0, 0.5);
...
public void CodD0_ClassSkillUsed(int client, int classID) {
	...
	if(CodD0_FireRocket(client, CodD0_SkillSlot_Class) == CodD0_SkillPrep_Available) {
