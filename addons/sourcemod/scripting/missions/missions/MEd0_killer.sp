...
public Plugin myinfo = {
        name = "Mission: Killer",
        author = "d0naciak",
        description = "Mission: Killer",
        version = "1.0.0",
        url = "d0naciak.pl"
};

char g_name[] = "Zabijaka";
char g_desc[] = "Zabij 20 przeciwników w ciągu jednej mapy";
int g_reqProgress = 20;
char g_award[] = "500 dośw., 20$";
...
public void MEd0_OnMissionComplete(int client, int missionID) {
	if(g_missionID == missionID) {
		CodD0_SetClientExp(client, CodD0_GetClientExp(client) + 500);
