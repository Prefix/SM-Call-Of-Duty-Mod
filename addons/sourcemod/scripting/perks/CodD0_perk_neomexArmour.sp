...
public Plugin myinfo =  {
	name = "CodD0 Perk: Neomex armour",
	author = "d0naciak",
	description =  "Neomex armour",
	version = "1.0",
	url = "d0naciak.pl"
}
...
public void OnPluginStart() {
	g_perkID = CodD0_RegisterPerk("Pancerz Neomexowy", "1/LW szans na odbicie pocisku", 3, 6);
}
...
public Action CodD0_PerkChanged(int client, int perkID, int perkValue) {
	if(g_perkID != perkID && g_hasPerk[client]) {
		CodD0_SetClientChanceToBounceBullet(client, CodD0_SkillSlot_Perk, 0);
...
public void CodD0_PerkChanged_Post(int client, int perkID, int perkValue) {
	if (perkID == g_perkID) {
		CodD0_SetClientChanceToBounceBullet(client, CodD0_SkillSlot_Perk, perkValue);
